...
const StatsSection = () => {
  ...
  return (
    <section id="stats-section" className={`py-16 ${theme === "dark" ? "bg-gray-800/50" : "bg-festival-maroon/5"}`}>
      <div className="festival-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mt-12">
          {/* Submissions Counter */}
          <div
            className={`card-festive p-6 text-center transform transition-all duration-700 hover:scale-105 hover:shadow-xl ${theme === "dark" ? "bg-gray-800 hover:bg-gray-700" : "hover:bg-festival-golden/10"} ${
          ...
          >
            <div className="flex justify-center mb-4">
              <div
                className={`w-16 h-16 rounded-full ${theme === "dark" ? "bg-amber-900/30" : "bg-festival-saffron/20"} flex items-center justify-center`}
              >
                <Camera size={32} className={`${theme === "dark" ? "text-festival-golden" : "text-festival-maroon"}`} />
              </div>
            </div>
            <h3
              className={`text-4xl font-bold ${theme === "dark" ? "text-festival-golden" : "text-festival-maroon"} mb-2`}
            >
          ...
          >
            <div className="flex justify-center mb-4">
              <div
                className={`w-16 h-16 rounded-full ${theme === "dark" ? "bg-rose-900/30" : "bg-festival-red/20"} flex items-center justify-center`}
              >
          ...
          >
            <div className="flex justify-center mb-4">
              <div
                className={`w-16 h-16 rounded-full ${theme === "dark" ? "bg-amber-800/30" : "bg-festival-golden/20"} flex items-center justify-center`}
              >
          ...
          >
            <div className="flex justify-center mb-4">
              <div
                className={`w-16 h-16 rounded-full ${theme === "dark" ? "bg-gray-700" : "bg-festival-cream"} flex items-center justify-center`}
              >

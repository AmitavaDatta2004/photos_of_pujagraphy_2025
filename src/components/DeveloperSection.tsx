    ...
    >
      <div className="festival-container">
        ...
        <div className="max-w-3xl mx-auto mt-10">
          <div className="card-festive overflow-hidden border border-festival-golden/30 hover:border-festival-golden hover:shadow-2xl transition-all duration-500 relative bg-gradient-to-br from-white to-festival-cream/20 dark:from-gray-800 dark:to-gray-900/80">
            {/* Decorative elements */}
            ...
            <div className="md:flex">
              <div className="md:w-1/3 bg-gradient-to-br from-festival-maroon/5 to-festival-saffron/5 dark:from-festival-maroon/10 dark:to-festival-saffron/10 flex items-center justify-center p-8">
                <div
                  className={`relative w-48 h-48 rounded-full overflow-hidden border-4 ${isHovered ? "border-festival-red" : "border-festival-golden"} transition-all duration-500 group shadow-lg`}
                ...
                >
                  ...
                  />
                  <div
                    className={`absolute inset-0 bg-gradient-to-t from-black/80 to-transparent flex items-end justify-center p-4 transition-opacity duration-500 ${isHovered ? "opacity-100" : "opacity-0"}`}
                  >
              ...
              <div className="md:w-2/3 p-8">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <h3 className="text-2xl font-medium text-festival-maroon dark:text-festival-golden">Amitava Datta</h3>
                ...
                <p className="mb-6 text-gray-700 dark:text-gray-300 leading-relaxed border-l-2 border-festival-saffron dark:border-festival-golden pl-4 italic">
                  "I'm passionate about creating digital experiences that celebrate our cultural heritage. 'Photos of
                  Pujagraphy' is a platform that aims to capture the essence of Durga Puja through the eyes of
